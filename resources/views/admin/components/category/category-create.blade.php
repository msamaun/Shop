                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <input oninput="newLmg.src=window.URL.createObjectURL(this.files[0])" type="file" class="form-control" id="categoryImage">
...
<script>
    async function Save(){
        ...
        showLoader()
        let res = await axios.post("/category-create",formData,config);
        hideLoader()

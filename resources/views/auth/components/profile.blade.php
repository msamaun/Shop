...
<script>
    ...
    async function ProfileCreate() {
        ...
        let res = await axios.post("/user-profile",postBody,HeaderToken());
    ...
    async function ProfileDetails(){
        let res = await axios.get("/userProfileRead",HeaderToken())
            document.getElementById('cus_name').value = res.data['cus_name']
            document.getElementById('cus_add').value = res.data['cus_add']
            document.getElementById('cus_city').value = res.data['cus_city']
            document.getElementById('cus_state').value = res.data['cus_state']
            document.getElementById('cus_postcode').value = res.data['cus_postcode']
            document.getElementById('cus_country').value = res.data['cus_country']
            document.getElementById('cus_phone').value = res.data['cus_phone']
            document.getElementById('cus_fax').value = res.data['cus_fax']

            document.getElementById('ship_name').value = res.data['ship_name']
            document.getElementById('ship_add').value = res.data['ship_add']
            document.getElementById('ship_city').value = res.data['ship_city']
            document.getElementById('ship_state').value = res.data['ship_state']
            document.getElementById('ship_postcode').value = res.data['ship_postcode']
            document.getElementById('ship_country').value = res.data['ship_country']
            document.getElementById('ship_phone').value = res.data['ship_phone']
